...
// Raw scales come from the handoff; semantic tokens bind to the
// CSS custom properties in src/styles/tokens.css so components can
// use classes like `bg-surface` / `text-primary` and theme-switch.
// ============================================================
  ...
  theme: {
    extend: {
      colors: {
        ...
        // ---- Semantic aliases (theme-aware, bound to CSS vars) ----
        bg: 'var(--bg)',
